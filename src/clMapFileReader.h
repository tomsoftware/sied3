...
public:
	...
	bool readMapArea(int *outBuffer_AraeHeightObjects = NULL, int sizeOfBuffer_AraeHeightObject = 0, int *outBuffer_PlayerAccessibleResources = NULL, int sizeOfBuffer_PlayerAccessibleResources = 0);
};
