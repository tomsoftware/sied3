...
class clBuilding_r_bladesmith : public absBuilding
{
...
public:
	...
	{
		Textures->createTextureInformation(absBuilding::enumType::BUILDING_BLADESMITH, 3);
		m_TexturePos = Textures->setTextureInformation(absBuilding::enumType::BUILDING_BLADESMITH, 0, gfxBuilding, 11, 8, 0);
	}
