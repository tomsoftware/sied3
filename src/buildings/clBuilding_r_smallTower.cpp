...
public:
	...
	{
		Textures->createTextureInformation(absBuilding::enumType::BUILDING_SMALL_TWOWER, 3);
		m_TexturePos = Textures->setTextureInformation(absBuilding::enumType::BUILDING_SMALL_TWOWER, 0, gfxBuilding, 17, 20, 0);
	}
