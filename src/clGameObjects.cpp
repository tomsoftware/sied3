...
void clGameObjects::load_game_objects(SDL_Renderer *renderer, clGFXFile &gfxObjects, clGFXFile::GFX_ObjectTexture txObjects[255])
{
	...
	gfxObjects.getTextureObject(&txObjects[enum_GAME_OBJECTS::GAME_OBJECT_TREE_ELM_2], renderer, 5, 5, 0);

	gfxObjects.getTextureObject(&txObjects[enum_GAME_OBJECTS::GAME_OBJECT_TREE_OAK], renderer, 4, 4, 0);
